/**
 * Cron: publish posts whose scheduled_publish_at is due (invoked from api/posts.js).
 */
const { sql } = require('./db');
const { ensurePostsSchema } = require('./ensurePostsSchema');
const { cronAuthResult } = require('./cronAuth');
const { sendScheduleAbandonAlert } = require('./scheduleAlert');
...
module.exports = async function handlePublishScheduled(req, res) {
