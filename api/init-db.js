  ...
  try {
    ...
    if (parseInt(scRows?.[0]?.c || 0) === 0) {
      const defaults = [
        ...
        ['site','site_pinterest',''],
        ['site','site_youtube',''],
        ['site','site_nav_social_email_only','0'],
    ...
    await sql`INSERT INTO site_content (page, key, value) VALUES ('site', 'site_nav_social_email_only', '0') ON CONFLICT (page, key) DO NOTHING`;
